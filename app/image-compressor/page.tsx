...
export default function ImageCompressorPage() {
  ...
  const schemaData = {
    ...
    url: 'https://toolkit.example.com/image-compressor',
  ...
  return (
    <>
      <Head>
        <link rel="canonical" href="https://toolkit.example.com/image-compressor" />
        ...
        <meta property="og:url" content="https://toolkit.example.com/image-compressor" />
