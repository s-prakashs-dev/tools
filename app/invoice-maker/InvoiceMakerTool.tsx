...
export default function InvoiceMakerTool() {
  ...
  const schemaData = {
    ...
    name: 'Free Invoice Maker Online',
    description: 'Free online GST invoice maker and PDF invoice generator for India.',
  ...
  return (
    <>
      ...
      <section className="prose max-w-none pt-10 text-gray-700">
        <h2 className="text-xl font-semibold text-gray-900">Using the invoice maker for the first time</h2>
        <p>
          This invoice maker is designed to help a first-time user build a professional invoice without any accounting software. Enter your company details, client details, items, and GST settings, and the invoice maker will calculate totals and taxes automatically. It is especially useful for small businesses and freelancers in India.
        </p>
        <p>
          The invoice maker is easy to follow because it shows each field clearly and updates the invoice instantly as you type. You can download the result as a PDF or print it directly, so the invoice maker saves time compared to creating invoices manually. Even if you are not familiar with GST, the tool explains the totals and splits the taxes clearly.
        </p>
        <p>
          Try this invoice maker when you need a simple, secure way to create GST invoices online. It gives first-time users confidence by keeping the process straightforward and the output professional.
        </p>
      </section>
    </>
  );
