  ...
  return (
    <>
      ...
      <section className="prose max-w-none pt-10 text-gray-700">
        <h2 className="text-xl font-semibold text-gray-900">Getting started with the password generator</h2>
        <p>
          This password generator is built for anyone who needs a secure password quickly. If you have never used a password generator before, start by choosing the length and the character options. The password generator will then create a strong, random password that is hard to guess and safe to use for accounts or logins.
        </p>
        <p>
          The password generator also offers UUID generation for unique identifiers. It is a friendly tool for first-time users because it explains the steps clearly and keeps the process simple. Generate one password or many at once, then copy the result directly to your clipboard.
        </p>
        <p>
          When you use the password generator, you do not need any technical setup. The tool makes it easy to create secure credentials with just a few clicks, so you can protect your online accounts right away.
        </p>
      </section>
    </>
  );
